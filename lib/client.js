...
let cc = Config.sessionName.replace(/ELSA-MD;;;/g, "").replace(/ELSA-MD;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
...
app.listen(port, () => console.log(`ARTHER MD Server listening on port http://localhost:${port}!`));
