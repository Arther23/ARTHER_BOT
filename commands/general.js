...
*💠⃝🧞 〘الـيـك فـروع مـجـتـمـعـنـا〙*

*💠⃝🧞 الـفـرع الاول https://chat.whatsapp.com/D2q8dnfUwbL83Tz79bGEKU*

*💠⃝🧞 الـفـرع الـثـانـي قـريـبـا...*`
        let buttonMessaged = {
...
cmd({
    ...
    async(Void, citel) => {
        ...
        let ter = `
ㅤ ────────────────────────── .°୭̥ ❁ 	
*💠⃝🧞الـسـرعـه⚡️┇ ${latensie.toFixed(4)} مـللـي ثـانـيـه*
*💠⃝🧞مـده الـتـشـغـيـل⏱┇ ${runtime(process.uptime())}*
*💠⃝🧞 الاصـدار📡┇ V2*
*💠⃝🧞 الـمـطـوريـن👤┇ ${Config.ownername}*
*💠⃝🧞 اسـم الـبـوت🤖┇ ${tlang().title}*
°୭̥ ❁ ───────────────────────── .°୭̥ ❁ `;
        let buttonMessaged = {
            image: {
                url: await botpic(),
